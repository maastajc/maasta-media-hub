import { Users, Film, User, Home, Calendar } from "lucide-react";
...
export function BottomNavigation() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-t border-border md:hidden">
      <nav className="flex items-center justify-around py-2 px-2 safe-area-inset-bottom">
